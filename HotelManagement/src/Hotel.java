...
public class Hotel {
    ...
    public static void bookroom(int i){
        ...
        switch (i){
            case 1: for (j=0;j<hotel_ob.luxury_doubleroom.length;j++){
            ...
            break;
            case 2:for (j=0;j<hotel_ob.deluxe_doubleroom.length;j++){
                ...
                break;
            case 3: for(j=0;j<hotel_ob.luxury_singleroom.length;j++){
                ...
                break;
            case 4: for (j=0;j<hotel_ob.deluxe_singleroom.length;j++){
    ...
    public static void bill(int rn,int rtype){
        double amount =0;
        String list[]={"Sandwich","Pasta","Noodle","Coke"};
        System.out.println("\n*****");
        ...
        switch (rtype){
            ...
            case 3:
                ...
                System.out.println("\nRoom Charge - "+2200);
                System.out.println("\n====================");
                System.out.println("Food Chargs:-");
                System.out.println("=============");
                System.out.println("Item Quantity Price");
                System.out.println("-------------------");
