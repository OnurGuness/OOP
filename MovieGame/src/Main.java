public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("The rules are simple, the computer randomly picks a movie title," +
                "and shows you now " + " many " + "letters it's made up of." );
        System.out.println("Your goal is to try to figure out the movie by guessing one letter at a time.");
        System.out.println("İf a letter is indeed in the title  the computer will reveal its correct position in" +
                "the"+ "word , if not, you lose a point");
        System.out.println("If you lose 10 points, game over!");
        System.out.println("Let's start");
        System.out.println("The movie title has " + game.getMovieTitle().length() +
